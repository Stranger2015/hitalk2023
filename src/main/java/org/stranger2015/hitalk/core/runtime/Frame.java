...
import org.stranger2015.hitalk.core.runtime.instructions.CodeClause;
...
public class Frame {
	...
	public
    List <Term> getVariables(){ return variables; }
	...
	public String toString(){
		...
		b.append("\t" + "cp:\t\t").append(cp_index).append(" (from clause ").append(cp_clause.belongsTo == null ? "query" : cp_clause.belongsTo).append(")\r\n");
		...
		if(type==CHOICEPOINT){
			...
			if(c==null) {
				...
				s = c.belongsTo+" instruction 0 = "+c.getInstruction(0);
			}
