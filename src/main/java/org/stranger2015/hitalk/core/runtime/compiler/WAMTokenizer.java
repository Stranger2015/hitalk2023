...
import compiler.RegisterAssigner;
...
import org.stranger2015.hitalk.core.compiler.tokens.ArgumentVariable;
import org.stranger2015.hitalk.core.compiler.tokens.CallToken;
import org.stranger2015.hitalk.core.compiler.tokens.CallVariableToken;
import org.stranger2015.hitalk.core.compiler.tokens.CompileToken;
import org.stranger2015.hitalk.core.compiler.tokens.ConstantToken;
import org.stranger2015.hitalk.core.compiler.tokens.CutToken;
import org.stranger2015.hitalk.core.compiler.tokens.DeallocateToken;
import org.stranger2015.hitalk.core.compiler.tokens.EndOfHead;
import org.stranger2015.hitalk.core.compiler.tokens.ListToken;
import org.stranger2015.hitalk.core.compiler.tokens.NumberToken;
import org.stranger2015.hitalk.core.compiler.tokens.ProceedToken;
import org.stranger2015.hitalk.core.compiler.tokens.StringRepresentationToken;
import org.stranger2015.hitalk.core.compiler.tokens.Structure;
import org.stranger2015.hitalk.core.compiler.tokens.SubtermRegister;

public class WAMTokenizer extends PrologBaseVisitor<Integer>{   
	private final Map<String, List<List<CompileToken>>> programTokens = new HashMap<>(); // All the gathered tokens, key = functor/arity
	private List<CompileToken> tokens = new ArrayList<>(); // Current tokens
	...
	private final PreProcessor preprocessor = new PreProcessor(); // Quantifies variables as permanent/temporary
	private final RegisterAssigner registerAssigner = new RegisterAssigner(preprocessor); // Assigns registers to parts of a subgoal
	private final Queue<ParseTree> queue = new LinkedList<ParseTree>(); // Tokens are added in breadth first order for which we need this queue
